...
class VotingButton extends React.PureComponent<Props> {
  ...
  private doVote (vote: boolean) {
    const { publicKey, queueExtrinsic, referendumId, systemAccountNonce = new BN(0) } = this.props;
...
export default withMulti(
  ...
  withObservable('systemAccountNonce', { paramProp: 'publicKey' })
);
